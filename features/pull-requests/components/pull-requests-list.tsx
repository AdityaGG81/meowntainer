  ...
  return (
    <div className="flex flex-col gap-2 border-b border-border py-4 last:border-b-0 last:pb-0 first:pt-0">
      <div className="flex flex-wrap items-center gap-2">
        <HugeiconsIcon icon={GitPullRequestIcon} className="size-4 shrink-0 text-muted-foreground" />
        <Link
...
function NoPullRequestsYet() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-2 p-6 text-center">
      <HugeiconsIcon icon={GitPullRequestIcon} className="size-8 text-muted-foreground" />
