...
import { LockIcon, StarIcon, CircleUnlock01Icon } from "@hugeicons/core-free-icons";
...
function VisibilityIcon({ visibility }: { visibility: DashboardRepo["visibility"] }) {
  if (visibility === "private") {
    return <HugeiconsIcon icon={LockIcon} className="size-3" />;
  }

  return <HugeiconsIcon icon={CircleUnlock01Icon} className="size-3" />;
}
