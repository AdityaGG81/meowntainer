...
import { CircleLock01Icon, CircleUnlock01Icon, StarIcon } from "@hugeicons/core-free-icons";
        ...
        <TableCell>
          <span className={statusBadge(tone, "gap-1")}>
            {repo.visibility === "private" ? (
              <HugeiconsIcon icon={CircleLock01Icon} className="size-3" />
            ) : (
              <HugeiconsIcon icon={CircleUnlock01Icon}  className="size-3" />
            )}
            {repo.visibility}
          </span>
        </TableCell>
