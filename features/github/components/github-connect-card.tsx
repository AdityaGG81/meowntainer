...
function DisconnectedActions({ installUrl }: { installUrl: string }) {
    return (
        ...
        >
            ...
            Install GitHub App
            <HugeiconsIcon icon={CircleArrowOutUpLeftIcon} className="size-3 opacity-80" />
        </Button>
    );
}
                ...
                <CardHeader>
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex items-center gap-3">
                            <span
                                className={cn(
                                    "flex size-15 items-center justify-center rounded-none border",
                                    iconWrapperClass
                                )}
                            >
                            ...
                            <div>
                                ...
                                <CardDescription>
                                    Install the Meowntainer app on your GitHub account or
